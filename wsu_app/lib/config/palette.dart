...
class Palette {
  static const Color primary = Color(0xFFF52CA5);
  static const Color secondary = Color(0xFFd62976);
  static const Color secondary_black = Color(0xFF05030B);
  static const Color secondary_orange = Color(0xFFfa7e1e);
  ...
  static const LinearGradient gradient1 = LinearGradient(
    ...
    colors: [primary, secondary_orange],
  );
